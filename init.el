...
(global-set-key (kbd "C-x C") (lambda () (interactive) (find-file (locate-user-emacs-file "init.el"))))
...
(global-set-key (kbd "C-x c") (lambda () (interactive) (find-file (locate-user-emacs-file "private.el"))))
